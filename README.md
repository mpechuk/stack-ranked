...
| `generate_rulebook_pdf.py` | Regenerates `docs/Synergy_Corp_Rulebook.pdf` from `docs/SYNERGY_CORP_RULEBOOK.md`, with optional `table-images/rulebook-header.png` cover art, a clickable table of contents, and PDF bookmarks (`pip install reportlab markdown beautifulsoup4`, then `python3 generate_rulebook_pdf.py`). |
...
| `rulebook-header-art-prompt.txt` | Reusable image-generation and integration prompt for the rulebook's optional cover banner. |
